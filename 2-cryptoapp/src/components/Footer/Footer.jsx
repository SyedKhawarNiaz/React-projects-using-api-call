...
function Footer() {
  return (
    <div>
      <section
        id="footer"
        className="relative overflow-hidden bg-black mt-10 -tracking-tight text-white py-8"
      >
            ...
            <div className="w-auto p-8">
              <div className="-m-1.5 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <a href="#">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border bg-yellow-50 border-red-500 hover:border-gray-400">
                      <svg
                        width="8"
                        height="14"
                        viewBox="0 0 8 14"
